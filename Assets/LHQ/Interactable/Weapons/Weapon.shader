	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 Emission = ( _IsHighLighted > 0.0 ? FresnelBaseColor35 : float4( 0,0,0,0 ) ).rgb;
				float3 Specular = 0.5;
				float Metallic = 0;
...
Node;AmplifyShaderEditor.GetLocalVarNode;38;-352,-176;Inherit;False;35;FresnelBaseColor;1;0;OBJECT;;False;1;COLOR;0
