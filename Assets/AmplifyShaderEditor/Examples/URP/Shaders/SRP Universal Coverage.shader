	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_MainTex128 = IN.ase_texcoord8.xy;
				float2 uv_Snow600 = IN.ase_texcoord8.xy;
				float2 uv_NormalMap132 = IN.ase_texcoord8.xy;
				float3 unpack132 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap132 ), _NormalScale );
				...
				float2 uv_SnowNormal601 = IN.ase_texcoord8.xy;
				float3 unpack601 = UnpackNormalScale( tex2D( _SnowNormal, uv_SnowNormal601 ), _SnowNormalScale );
				unpack601.z = lerp( 1, unpack601.z, saturate(_SnowNormalScale) );
				float3 lerpResult605 = lerp( tex2DNode132 , unpack601 , temp_output_606_0);
				
				float lerpResult610 = lerp( 0.0 , 0.0 , temp_output_606_0);
				

				float3 BaseColor = lerpResult604.rgb;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 uv_MainTex128 = IN.ase_texcoord4.xy;
				float2 uv_Snow600 = IN.ase_texcoord4.xy;
				float2 uv_NormalMap132 = IN.ase_texcoord4.xy;
				float3 unpack132 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap132 ), _NormalScale );
				unpack132.z = lerp( 1, unpack132.z, saturate(_NormalScale) );
				float3 tex2DNode132 = unpack132;
		...
		Pass
		{
						 ...
						 )
			{
				...
				float2 uv_NormalMap132 = IN.ase_texcoord5.xy;
				float3 unpack132 = UnpackNormalScale( tex2D( _NormalMap, uv_NormalMap132 ), _NormalScale );
				unpack132.z = lerp( 1, unpack132.z, saturate(_NormalScale) );
				float3 tex2DNode132 = unpack132;
				float2 uv_SnowNormal601 = IN.ase_texcoord5.xy;
				float3 unpack601 = UnpackNormalScale( tex2D( _SnowNormal, uv_SnowNormal601 ), _SnowNormalScale );
				unpack601.z = lerp( 1, unpack601.z, saturate(_SnowNormalScale) );
...
Node;AmplifyShaderEditor.SamplerNode;132;256,-448;Inherit;True;Property;_NormalMap;NormalMap;1;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;white;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=25173F1662F930531FB484CE00CB6C45821A5AD9